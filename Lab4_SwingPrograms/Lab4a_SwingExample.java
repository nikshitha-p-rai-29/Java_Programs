...
import javax.swing.*; 
public class Lab4a_SwingExample {
Lab4a_SwingExample () { 
//Create a new JFrame container. 
JFrame jfrm = new JFrame("A Simple Swing Application"); 
//jfrm.setFont("Serif",Font.BOLD,18); 
//label = new JLabel("A label"); label.setFont(new Font("Serif", Font.PLAIN, 14)); //Give the frame an initial size. 
jfrm.setSize(275, 100); 
//Terminate the program when the user closes the application. 
jfrm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); 
//Create a text-based label. 
JLabel jlab = new JLabel(" Hello! VI B , Welcome to Swing Programming!"); // set properties for label 
