...
package Lab3_StringOperations.Lab3a_StringOperation; 
public class Lab3a_StringHandlingDemo { 
 ...
 System.out.println("str1 equals str3 (ignore case): " + str1.equalsIgnoreCase(str3));  System.out.println("str1 compareTo str3: " + str1.compareTo(str3)); 
  
 // Searching in Strings 
 System.out.println("\n=== String Searching ==="); 
 System.out.println("Index of 'World' in str1: " + str1.indexOf("World"));  System.out.println("Last index of 'o' in str1: " + str1.lastIndexOf('o')); 
 ...
 System.out.println("Using + operator: " + concat1 + " " + concat2);  System.out.println("Using concat(): " + concat1.concat(" ").concat(concat2));   
 // String Splitting 
 System.out.println("\n=== String Splitting ==="); 
 ...
 // String Formatting 
 System.out.println("\n=== String Formatting ==="); 
 String formatted = String.format("Name: %s, Age: %d, Height: %.2f", "John", 25, 1.75);  System.out.println("Formatted string: " + formatted); 
 ...
 boolean isValidEmail = validateEmail(email);  System.out.println("Email: " + email); 
 System.out.println("Is valid: " + isValidEmail);  } 
  
 // Helper method for email validation 
 private static boolean validateEmail(String email) {  // Basic email validation 
 return email != null && 
 email.contains("@") && 
 email.contains(".") && 
 email.indexOf("@") < email.lastIndexOf(".") &&  !email.startsWith("@") && 
 !email.endsWith(".") && 
 email.length() >= 5; 
 } 
} 
